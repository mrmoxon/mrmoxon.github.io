...
![Graphs](/assets/superlinears.webp)
<br>
*Figures 1 & 2. Two important observations of the same exponential curve, visualised by Urban.* [[2]](#ref-2)
...
Despite this, TSMC and Samsung have both claimed to keep pace in their hardware with 10nm and 7nm nodes in mass production, 5nm nodes in risk production (used in the M1), and 3nm and 2nm nodes on the horizon by 2024. [[6]](#ref-6)
...
<b>Deep Learning efficiencies</b> - New software systems can make programme applications go faster, independent of the chip. Nvidia has spoken about this and generally have referred to it as "Huang's Law". This drove much of the speed up by the Google Brain team concerning TensorFlow. [[8]](#ref-8)
...
[2]<a id="ref-2"></a> Tim Urban's take on the singularity - [Wait But Why](https://waitbutwhy.com/2015/01/artificial-intelligence-revolution-1.html).

[3]<a id="ref-3"></a> Boom Supersonic's mission and Musk's comments on transnational rocket flights.

[4]<a id="ref-4"></a> Moore's Law and Stigler's Law of Eponymy.

[5]<a id="ref-5"></a> Roger Stough's 1996 paper on early exponential growth from an architectural perspective.

[6]<a id="ref-6"></a> TSMC microprocessors development and Moore's Law deceleration analysis.

[7]<a id="ref-7"></a> Max Tegmark's interview with Sam Harris on AI and computing advancement.

[8]<a id="ref-8"></a> [Huang's Law](https://rbharath.github.io/the-advent-of-huangs-law/) coverage by Bharath Ramsundar.

[9]<a id="ref-9"></a> Ray Kurzweil on "Skyscraper Microchips".

[10]<a id="ref-10"></a> Amazon Web Services and technological growth trends.